var twitch = (function (exports) {
    ...
    let fetch$2 = null;
    const initReq = (fetchFunc) => fetch$2 = fetchFunc;
    ...
    const request = async (options) => {
        ...
        const response = await fetch$2(url, fetchOptions);
    ...
    let fetch$1 = null;
    const initFetch = (fetchFunc) => fetch$1 = fetchFunc;
